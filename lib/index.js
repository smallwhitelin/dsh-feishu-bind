...
export function createBindService({ config, log = () => {}, deps = {} }) {
  ...
  async function startFlow(opts = {}) {
    ...
    rt.pendingInstance = forceCreate && config.independentInstances
  ...
  async function applyBindings(opts = {}) {
    try {
      ...
      if (opts.newInstance && config.independentInstances) {
  ...
  function snapshot() {
    ...
    return {
      ...
      independentInstances: Boolean(config.independentInstances),
